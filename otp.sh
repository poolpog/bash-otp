...
U_MODE="$( echo $TOKENFILES_DIR_MODE | awk  -FS="" '{print $1 $2 $3}' )"
G_MODE="$( echo $TOKENFILES_DIR_MODE | awk  -FS="" '{print $4 $5 $6}' )"
A_MODE="$( echo $TOKENFILES_DIR_MODE | awk  -FS="" '{print $7 $8 $9}' )"
